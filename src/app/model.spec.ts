...
describe('Model: shift', () => {
  ...
  const tests: ShiftTest[] = [
    ...
    {
      title: 'shift up combine game over',
      fnName: 'up',
      newCellsNewGame: [
        { position: { row: 3, column: 1 }, newCell: 4 },
        { position: { row: 2, column: 2 }, newCell: 2 },
    ...
    {
      title: 'shift right combine -> move',
      fnName: 'right',
      newCellsNewGame: [
        { position: { row: 2, column: 1 }, newCell: 2 },
        { position: { row: 2, column: 2 }, newCell: 2 },
    ...
    {
      title: 'shift right combine game over',
      fnName: 'right',
      newCellsNewGame: [
        { position: { row: 0, column: 2 }, newCell: 2 },
        { position: { row: 2, column: 1 }, newCell: 4 },
    ...
    {
      title: 'shift down combine game over',
      fnName: 'down',
      newCellsNewGame: [
        { position: { row: 1, column: 1 }, newCell: 2 },
        { position: { row: 1, column: 2 }, newCell: 2 },
    ...
    {
      title: 'shift left multiple combine',
      fnName: 'left',
      newCellsNewGame: [
        { position: { row: 0, column: 3 }, newCell: 4 },
        { position: { row: 2, column: 1 }, newCell: 2 },
